...
import heroBg from "../../imports/스폰.png";
import logoImg from "figma:asset/3fecc59dd1bf5ea62681da7d1507fd583af0d56b.png";
...
const searchData: SearchItem[] = [
  ...
  },
  {
    id: "island",
    title: "섬 시스템",
    content: "섬 업그레이드 권한 워프 은행 호퍼 꿀벌 인원 크기",
    category: "콘텐츠",
    emoji: "🏝️",
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div className="lg:col-span-2 bg-white border-2 border-amber-200 rounded-2xl overflow-hidden shadow-sm flex flex-col">
          ...
          >
            ...
            <Link
              to="/daily-rewards"
              className="flex items-center gap-1 rounded-lg px-2.5 py-1 transition-colors hover:bg-amber-300/40"
              style={{ fontSize: "12px", fontWeight: 700, color: "#78350f" }}
            >
