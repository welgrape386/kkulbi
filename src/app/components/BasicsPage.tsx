...
function FaqContent() {
  const faqs = [
    ...
    { q: "광물변환은 뭔가요?", a: "/광물변환 활성화 시 광물들이 드롭되지 않는 대신, 크리스탈 확률이 상승합니다. 태양열의 경우, 태양열 효과가 강화된 비율만큼 크리스탈 확률이 증가해요. 특성 효과로 인해 드롭되는 광물은 여전히 나올 수 있어요." },
    ...
    { q: "낚시 시 쉬프트 누르면 고정키 창이 뜨는데 어떻게 하나요?", a: "윈도우 검색창에 '고정 키' 검색 → 첫 번째 클릭 → 고정키 사용을 '끔'으로 변경하면 해결돼요! 낚시 미니게임에서 쉬프트를 자유롭게 사용할 수 있게 됩니다." },
