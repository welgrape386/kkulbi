...
const cookingTools = [
  {
    ...
    icon: "🔪",
    material: "식칼 필요",
    examples: ["자른당근", "김치", "수박주스"],
  },
  {
    name: "프라이팬",
    icon: "🍳",
    material: "가스레인지 + 뒤집개",
    examples: ["타코", "애플파이", "오믈렛", "또띠아"],
  },
  {
    name: "냄비",
    icon: "🍲",
    material: "물병 + 뒤집개",
    examples: ["라면", "육개장", "시리얼", "미역국"],
  },
  {
    name: "튀김기",
    icon: "🍟",
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 space-y-6">
        ...
        >
          ...
          >
            ...
            레시피 순서를 반드시 지켜야 해요! 순서를 틀리면{" "}
            <strong>썩은 음식</strong>이 나와요 🚫
          </p>
        </div>
        ...
        <div className="rounded-2xl border-2 border-amber-200 bg-white">
          ...
          <div className="p-5 grid grid-cols-1 sm:grid-cols-2 gap-3">
            {cookingTools.map((tool) => (
              <div
                key={tool.name}
                className="p-4 rounded-xl border-2 border-orange-100 bg-orange-50"
              >
        ...
        <div className="rounded-2xl border-2 border-amber-200 bg-white">
          <div className="px-5 py-4 border-b-2 border-amber-100 flex items-center justify-between">
            ...
            <span
              className="rounded-full px-2 py-0.5 bg-slate-100 text-slate-500"
