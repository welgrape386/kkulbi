...
const legend = [
  ...
  {
    label: "강화서",
    style: "bg-violet-100 text-violet-800 border border-violet-200",
  },
  {
    label: "주문서",
  ...
  {
    label: "뼈·뼈가루",
    style: "bg-stone-100 text-stone-700 border border-stone-200",
  },
  {
    label: "자연 재료",
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
        ...
        {today >= 1 && today <= 31 && (
          ...
          >
            ...
            <div>
              <div
                style={{ fontSize: "14px", fontWeight: 800, color: "#92400e" }}
              >
                오늘은 {today}일차 보상!
              </div>
              ...
              >
                ...
                <div
                  ...
                  style={{
                    ...
                    boxShadow:
                      r.day === today
                        ? "0 2px 10px rgba(245,200,66,0.5)"
                        : "none",
                  }}
                >
                  {r.day}
