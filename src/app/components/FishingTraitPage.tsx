...
const allSkills = [
  ...
  { lv: 100, name: "월척 Ⅱ", type: "패시브", desc: "낚시 시 0.7% 확률로 보물 물고기 획득", cost: "20,000,000원" },
  ...
  { lv: 150, name: "월척 Ⅲ", type: "패시브", desc: "낚시 시 1% 확률로 보물 물고기 획득", cost: "130,000,000원" },
  ...
  { lv: 200, name: "월척 Ⅳ", type: "패시브", desc: "낚시 시 1.5% 확률로 보물 물고기 획득", cost: "300,000,000원" },
...
const customFish = [
  ...
  { name: "메기", emoji: "🐟" }, { name: "잉어", emoji: "🐟" }, { name: "정어리", emoji: "🐟" },
  { name: "참치", emoji: "🐟" }, { name: "해파리", emoji: "🪼" }, { name: "푸른 해파리", emoji: "🪼" },
            ...
            <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-3">
              {customFish.map((fish) => (
                <div key={fish.name} className="flex flex-col items-center gap-1 p-3 rounded-xl border-2 border-teal-100 bg-teal-50 text-center hover:shadow-md transition-shadow">
                  <div className="w-12 h-12 rounded-xl bg-teal-100 flex items-center justify-center text-2xl border border-teal-200">{fish.emoji}</div>
