...
const allSkills = [
  ...
  },
  {
    ...
    name: "수산시장 Ⅰ",
    type: "패시브",
    desc: "물고기 판매 시 판매금의 10% 추가 획득 (일반 상점에서만 효과 적용)",
    cost: "7,000,000원",
  },
  {
    lv: 60,
  ...
  },
  {
    ...
    name: "수산시장 Ⅱ",
    type: "패시브",
    desc: "물고기 판매 시 판매금의 20% 추가 획득 (일반 상점에서만 효과 적용)",
    cost: "50,000,000원",
  },
  {
    lv: 130,
  ...
  },
  {
    ...
    name: "수산시장 Ⅲ",
    type: "패시브",
    desc: "물고기 판매 시 판매금의 30% 추가 획득 (일반 상점에서만 효과 적용)",
    cost: "200,000,000원",
  },
  {
    lv: 180,
...
const rodUpgrades = [
  {
    name: "자연의 낚싯대",
    recipe: "일반인의 낚싯대 1개 & 우아한 바다진주 10개",
  },
  ...
  {
    name: "마스터 낚싯대",
    recipe: "황금색 낚싯대 1개 & 우아한 바다진주 120개",
  },
  {
    name: "이리듐 낚싯대",
    recipe: "마스터 낚싯대 1개 & 우아한 바다진주 150개",
  },
  {
    name: "우주별 낚싯대",
    recipe: "이리듐 낚싯대 1개 & 우아한 바다진주 200개",
  },
];
...
const pearls = [
  {
    name: "해조의 구슬",
    emoji: "🌿",
    effect: "우아한 바다 진주 확률 증가",
    color: "#16a34a",
  },
  {
    name: "해류의 구슬",
    emoji: "🌊",
    effect: "물고기 등급 업 확률 증가",
    color: "#0284c7",
  },
  {
    name: "해심의 구슬",
    ...
    <div style={{ background: BG, minHeight: "100vh" }}>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 space-y-6">
        ...
        >
          ...
          >
            낚시터 또는 섬에서 물고기를 낚고, 낚은 물고기를 NPC에게 팔아 돈을
            버는 직업이에요.
          </p>
        </div>
        ...
        <div className="rounded-2xl border-2 border-amber-200 bg-white">
          ...
          <div className="p-5 space-y-2">
            {[
              {
                icon: "1️⃣",
                text: "입질이 오면 우클릭을 한 번 누른 다음, 미니게임이 뜨면 초록색에 우클릭 해줍니다.",
              },
              {
                icon: "2️⃣",
                text: "물고기는 낚시터 근처에 있는 NPC에게 판매할 수 있어요.",
              },
              {
                icon: "3️⃣",
                text: "움직이는 속도는 랜덤이고, 움직이는 하얀 선을 기준으로 잡으시면 됩니다.",
              },
            ].map((item) => (
              <div
                key={item.icon}
                className="flex items-start gap-3 p-3 rounded-xl bg-sky-50 border border-sky-100"
              >
        ...
        <div className="rounded-2xl border-2 border-blue-200 bg-white">
          <div className="px-5 py-4 border-b-2 border-blue-100 flex items-center gap-2">
            <span className="text-lg">🎮</span>
            <span
              style={{ fontSize: "15px", fontWeight: 800, color: "#1e40af" }}
            >
              미니게임
            </span>
          </div>
          <div className="p-5 space-y-2">
            {[
              ...
              <div
                key={i}
                className="flex items-start gap-2 p-3 rounded-xl bg-blue-50 border border-blue-100"
              >
                <span
                  className="w-5 h-5 rounded-full bg-blue-500 text-white flex items-center justify-center flex-shrink-0 mt-0.5"
        ...
        <div className="rounded-2xl border-2 border-amber-300 bg-amber-50 p-5">
          ...
          <div className="space-y-2">
            ...
            >
              쉬프트를 5번 누르면 <strong>고정 키</strong> 라는 창이 떠서 방해가
              되는데, 끄고 하면 낚시가 편해져요!
            </p>
            <div className="flex items-center gap-2 mt-2 p-3 rounded-xl bg-white border border-amber-200">
              <span className="text-base">💻</span>
              <p
                style={{ fontSize: "12px", color: "#92400e", fontWeight: 700 }}
              >
                윈도우 검색창에 <strong>'고정 키'</strong> 검색 → 첫번째 클릭 →
                고정키 사용을 <strong>'끔'</strong>으로 변경
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-2xl border-2 border-amber-200 bg-white">
          ...
          <div className="p-5">
            ...
            >
              🪸 <strong>우아한 바다진주</strong>를 사용하여 낚시대를 업그레이드
              해보세요!
            </p>
                  ...
                  {rodUpgrades.map((rod, i) => (
                    ...
                    >
                      <td className="px-4 py-3">
                        <span
                          className="inline-flex items-center gap-1.5 rounded-xl px-3 py-1 text-white"
                          style={{
                            background: `hsl(${200 + i * 15}, 70%, ${40 + i * 5}%)`,
                            fontSize: "12px",
                            fontWeight: 800,
                          }}
                        >
        ...
        <div className="rounded-2xl border-2 border-purple-200 bg-white">
          <div className="px-5 py-4 border-b-2 border-purple-100 flex items-center gap-2">
            <span className="text-lg">🔮</span>
            <span
              style={{ fontSize: "15px", fontWeight: 800, color: "#7c3aed" }}
            >
              수수께끼 구슬 강화
            </span>
          </div>
          <div className="p-5 space-y-4">
            ...
            >
              수수께끼 구슬로 낚시대를 강화할 수 있어요! 빈칸에 낚시대를 올리고{" "}
              <strong>강화하기</strong>를 누르면 됩니다!
            </p>
            <p style={{ fontSize: "13px", color: "#374151", lineHeight: 1.6 }}>
              수수께끼 구슬에서는 <strong>해조, 해류, 해심</strong> 총 3가지
              종류의 구슬 중 하나의 구슬이 나옵니다.
            </p>
            ...
            <div className="p-4 rounded-xl bg-purple-50 border-2 border-purple-200 space-y-2">
              <div className="flex items-start gap-2">
                ...
                >
                  강화는 종류별로 총 <strong>7강</strong>까지 있으며, 강화
                  단계가 높아질수록 강화 확률이 낮아집니다.
                </p>
              </div>
              <div className="flex items-start gap-2">
                ...
                >
                  강화 실패 시, 구슬의 효과가 <strong>1단계 하락</strong>됩니다.
                  단, <strong>1강 이하로는 떨어지지 않습니다.</strong>
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="rounded-2xl border-2 border-teal-200 bg-white">
          ...
          <div className="p-5">
            ...
            >
              🌊 커스텀 물고기의 종류를 알려드릴게요. (각 물고기 이미지 추가
              예정)
            </p>
            <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-3">
              {customFish.map((fish) => (
                <div
                  key={fish.name}
                  className="flex flex-col items-center gap-1 p-3 rounded-xl border-2 border-teal-100 bg-teal-50 text-center hover:shadow-md transition-shadow"
                >
        ...
        <div className="rounded-2xl border-2 border-amber-300 bg-white">
          <div className="px-5 py-4 border-b-2 border-amber-200 flex items-center gap-2">
            <span className="text-lg">💎</span>
            <span
              style={{ fontSize: "15px", fontWeight: 800, color: "#b45309" }}
            >
              보물 물고기
            </span>
            <span
          ...
          <div className="p-5">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
              {treasureFish.map((fish) => (
                <div
                  key={fish.name}
                  className="flex flex-col items-center gap-2 p-3 rounded-xl border-2 border-amber-200 bg-amber-50 text-center hover:shadow-md transition-shadow"
                >
