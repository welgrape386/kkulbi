...
function EventsSection() {
  ...
  const previewRewards = allDailyRewards.slice(0, 10);
              ...
              >
                ...
                {r.day === today && (
                  <span
                    ...
                    style={{ background: "linear-gradient(135deg, #f5c842, #f59e0b)", color: "#1a1200", fontSize: "10px", fontWeight: 800 }}
                  >
                    오늘!
                  </span>
                )}
...
export function Home() {
  return (
    <div>
      {/* Hero */}
      <div className="relative overflow-hidden" style={{ minHeight: "640px" }}>
        <img
          src={spawnImg}
          alt="꿀비의 숲 서버"
