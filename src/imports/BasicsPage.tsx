      ...
      <div className="bg-white border border-amber-100 rounded-2xl p-6 shadow-sm">
        ...
        <div className="space-y-4">
          <div className="p-4 rounded-2xl" style={{ background: "#1a1200", border: "2px solid #f5c842" }}>
            <div className="text-amber-400 mb-2" style={{ fontSize: "11px", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.8px" }}>국내 서버 주소 | 해외 서버 주소</div>
            <div className="text-amber-300" style={{ fontSize: "18px", fontWeight: 900 }}>Kkulbi.kr | Kkulbiglobal.skhidc.kr</div>
