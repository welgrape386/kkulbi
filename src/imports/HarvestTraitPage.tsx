        ...
        <div className="rounded-2xl border-2 border-amber-200 bg-white">
          ...
          <div className="p-5 space-y-3">
            <div className="p-4 rounded-xl border-2 border-green-100 bg-green-50">
              <div style={{ fontSize: "13px", fontWeight: 800, color: "#166534", marginBottom: "6px" }}>Q. 지렁이와 산삼에 관하여</div>
              <div style={{ fontSize: "13px", color: "#4b7c5e", lineHeight: 1.7 }}>
                A. 수확 특성인 유저분들은 <strong>지렁이</strong>와 <strong>산삼씨앗</strong>을 더 많이 획득할 수 있어요!<br />
                <strong>지렁이</strong>는 <strong>섬세한 손길</strong> 인챈트가 있을 때만 드랍돼요. 추가로, 지렁이의 경우에는 <strong>행운</strong> 수치가 높을수록 확률이 올라가요!
              </div>
            </div>
            ...
            <div className="border-t-2 border-amber-100 p-5 space-y-5">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                  {[
                    ...
                    <div key={item.text} className="p-3 rounded-xl bg-green-50 border-2 border-green-400 flex flex-col items-center justify-center text-center" style={{ minHeight: "96px" }}>
              ...
              <div>
                ...
                <p className="mb-3" style={{ fontSize: "13px", color: "#374151", lineHeight: 1.6 }}>
                  커스텀 농작물을 키우기 위해서는 경작지에 물을 뿌려줘야 해요. 물뿌리개를 들고 <strong>물에 우클릭</strong>하면 물뿌리개에 물을 채울 수 있어요.
                </p>
              ...
              <div>
                ...
                <p className="mb-3" style={{ fontSize: "13px", color: "#374151", lineHeight: 1.6 }}>
                  비료를 사용하면 높은 등급의 농작물이 나올 확률이 증가합니다. 비료는 마인크래프트 시간으로 <strong>28일 (약 9시간)</strong>간 유지됩니다.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                  {fertilizers.map((f) => (
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {customCrops.map((crop) => (
                    <span key={crop} className="rounded-xl px-3 py-1.5 border-2 border-green-200" style={{ background: "#f0fdf4", color: "#15803d", fontSize: "12px", fontWeight: 700 }}>
                      🌿 {crop}
                    </span>
                  ))}
                </div>
