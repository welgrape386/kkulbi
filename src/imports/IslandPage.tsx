...
const upgrades = [
  ...
  {
    title: "섬 꿀벌 확장", icon: "🐝", color: "#d97706", unit: "마리",
    stages: [
      { stage: 1, value: "10", cost: "0원 (기본)" }, { stage: 2, value: "12", cost: "50,000,000원" },
      { stage: 3, value: "15", cost: "100,000,000원" }, { stage: 4, value: "17", cost: "300,000,000원" },
      { stage: 5, value: "20", cost: "500,000,000원" },
    ],
  },
  {
    title: "섬 창고 제한", icon: "📦", color: "#16a34a", unit: "번",
    stages: [
      { stage: 1, value: "1", cost: "0원 (기본)" }, { stage: 2, value: "2", cost: "5,000,000원" },
      { stage: 3, value: "3", cost: "10,000,000원" }, { stage: 4, value: "4", cost: "30,000,000원" },
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 space-y-8">
        ...
        <SectionCard>
          ...
          <div className="p-6 space-y-4">
            <Collapsible
              defaultOpen
              title={<span>🔐 섬 권한 설정 <code className="text-xs bg-amber-100 rounded px-1">/섬 권한</code> — 대표·관리자·고정주민·주민·아르바이트·방문자 설정 가능</span>}
            >
            ...
            <Collapsible
              title={<span>🌦️ 섬 환경 설정 <code className="text-xs bg-amber-100 rounded px-1">/섬 설정</code> — 시간·날씨·환경 토글</span>}
            >
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  ...
                  <tbody>
                    {upg.stages.map((s) => (
                      <tr key={s.stage} className="border-t" style={{ borderColor: upg.color + "20" }}>
                        ...
                        <td className="px-3 py-2" style={{ fontSize: "12px", fontWeight: 700, color: "#374151" }}>{s.value}{upg.unit}</td>
