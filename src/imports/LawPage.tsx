...
function ArticleCard({ article, forceOpen }: { article: Article; forceOpen?: boolean }) {
  ...
  return (
    <div className="bg-white border border-amber-100 rounded-2xl overflow-hidden shadow-sm">
      ...
      >
        ...
        <ChevronDown className={`w-5 h-5 text-amber-400 flex-shrink-0 transition-transform ${isOpen ? "rotate-180" : ""}`} />
      </button>
      {isOpen && (
    ...
    <div style={{ background: "#fffbef", minHeight: "100vh" }}>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="flex items-center gap-2 text-amber-600 mb-4" style={{ fontSize: "13px" }}>
          ...
          <span>›</span>
          <span className="text-slate-600">⚖️ 원영원칙 (법전)</span>
        </div>
        ...
        <div className="bg-white border-2 border-amber-200 rounded-3xl p-6 mb-8 shadow-sm">
          ...
          <div className="flex gap-2 mt-4">
            <button
              ...
              style={{ background: "#f5c842", color: "#1a1200", fontSize: "13px", fontWeight: 700 }}
            >
              전체 펼치기
            </button>
            <button
              ...
              style={{ background: "#f1f5f9", fontSize: "13px", fontWeight: 600 }}
            >
              전체 접기
            </button>
          </div>
        ...
        <div className="space-y-3">
          {articles.map((article) => (
            <ArticleCard key={article.no} article={article} forceOpen={allOpen} />
          ))}
        </div>
